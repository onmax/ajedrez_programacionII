...
public class TestIntegridadPiezas {
	...
	public static void setup () {
		constructores.add(new Metodo (null,null, new String [] {"progii.juegotablero.model.Jugador", "int", "int"}));
		metodos.add(new Metodo ("puedeMover", "boolean", new String [] {"int", "int", "boolean"})); 
	}
	...
	public void testPiezaAjedrez () {
		...
		testMetodo (m, clazz); 
		m = new Metodo ("puedeMover", "boolean", new String [] {"int", "int", "boolean"});
		testMetodo (m, clazz); 
	}
